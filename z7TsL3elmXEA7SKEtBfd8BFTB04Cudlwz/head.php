...
<head> 
	...
	<link rel="stylesheet" href="<?php echo $dir?>css/fontawesome-all.min.css" type="text/css" media="all" />
...
<body bgcolor="#FFFFFF" onkeypress="keyPressDetect(event);" onkeyup="keyUpDetect(event);">
